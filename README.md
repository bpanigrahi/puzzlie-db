...
Now you're ready to start working with the app. Clone the repo and change to the directory where the sample app is located.
  ```
git clone https://github.com/IBM-Cloud/puzzlie-db
cd puzzlie-db
  ```

  Peruse the files in the *puzzlie-db* directory to familiarize yourself with the contents.
...
From within the *puzzlie-db* directory push your app to IBM Cloud
  ```
cf push
  ```
...
1. Create a file called `vcap-local.json` in the `puzzlie-db` directory with the following content:
  ```
  {
    "services": {
      "cloudantNoSQLDB": [
